...
<div class="home-hero">
<p class="home-hero__eyebrow">A Working Identity · CUA Columbus School of Law</p>
<h1 class="home-hero__title">Law &amp; Entrepreneurship</h1>
<p class="home-hero__lead">{{ page.hero_subtitle }}</p>
<div class="home-cta">
...
<h3><a href="{{ '/for-students/' | relative_url }}">Learn</a></h3>
<p>For prospective and current students. The cohort, the clinic, the curriculum, and how to engage now.</p>
</div>

<div class="audience-card">
<h3><a href="{{ '/teach/' | relative_url }}">Teach</a></h3>
<p>For academic peers and visiting scholars. Working papers, symposia, visiting-scholar arrangements, co-authoring.</p>
</div>
...
<div class="audience-card">
<h3><a href="{{ '/support/' | relative_url }}">Support</a></h3>
<p>For donors and funders. Named gift opportunities tied to specific deliverables.</p>
</div>

<div class="audience-card">
<h3><a href="{{ '/partner/' | relative_url }}">Partner</a></h3>
<p>For institutions. Catholic-affiliated mission organizations, peer law schools, CUA programs, foundations.</p>
</div>

<div class="audience-card">
<h3><a href="{{ '/press/' | relative_url }}">Press</a></h3>
<p>For journalists and media. The program in one paragraph, topics, bios, contact.</p>
</div>
