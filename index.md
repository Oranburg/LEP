...
permalink: /
hero_subtitle: "The partnership form of justice in commercial life: a working space for the intellectual identity of the Law and Entrepreneurship Program at the Catholic University of America Columbus School of Law."
---
...
<ol class="start-ordered">
  ...
  <li><a href="{{ '/working-papers/' | relative_url }}">Working papers</a></li>
  <li><a href="{{ '/events/' | relative_url }}">Events</a></li>
  <li><a href="{{ '/readings/' | relative_url }}">Readings</a></li>
  <li><a href="{{ '/collaborators/' | relative_url }}">Collaborators</a></li>
