...
citations_to_verify:
  - id: holzer_kent_2013
    status: CONFIRMED
    description: "Elie Holzer & Orit Kent, A Philosophy of Ḥavruta (Boston: Academic Studies Press, 2013). Publisher and year confirmed; cited without page pin."
  - id: wimpfheimer_2018
    status: CONFIRMED
    description: "Barry Scott Wimpfheimer, The Talmud: A Biography (Princeton UP, 2018). Cited without page pin (general reference)."
  - id: magnifica_140
    status: CONFIRMED
    description: "Leo XIV, Magnifica Humanitas §140 (15 May 2026). The §140 passage on the 'desire to ask questions' and Plato's Seventh Letter is confirmed via project research file. The body's 'flint' image is a paraphrase of Plato's spark metaphor."
resolved_2026_05_31:
  - "Lerner 2004 footnote removed (citation unverifiable)."
  - "Weiss 'Art of Ḥavruta' footnote removed (essay not located)."
  - "Holzer & Kent wrong ISBN removed (citation form clean without ISBN)."
---
...
The pedagogy of ḥavruta is not new. It is traceable through two millennia of Jewish communal life, carried by families, academies, and communities across widely different political conditions. That continuity is evidence of something: a method that compels judgment formation survives because the communities practicing it valued judgment enough to transmit the method even when the surrounding institutions did not require them to. The structural account of that survival is the subject of [The Three States of a Living Tradition]({{ '/essays/three-states/' | relative_url }}), where ḥavruta is named as the paradigm case of communal transmission without institutional infrastructure. Educators who want to form judgment in the age of AI do not need to invent a new practice. They need to recover an old one and decide whether the new medium can serve the old purpose or only subvert it.

---

[^fn-holzer-kent]: Elie Holzer and Orit Kent, *A Philosophy of Ḥavruta: Understanding and Teaching the Art of Text Study in Pairs* (Boston: Academic Studies Press, 2013).

[^fn-wimpfheimer]: Barry Scott Wimpfheimer, *The Talmud: A Biography* (Princeton: Princeton University Press, 2018) (treating havruta as the cumulative pedagogical practice that sustained the rabbinic academy).

[^fn-leo-magnifica]: Leo XIV, *Magnifica Humanitas* § 140 (Vatican City: Libreria Editrice Vaticana, 2026). The "flint" image in the body paraphrases the encyclical's spark metaphor, which the encyclical itself draws from Plato's Seventh Letter.
