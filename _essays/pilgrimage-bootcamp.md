...
The first is a founding-cohort pilgrimage. A small inaugural cohort of LEP students, faculty, and practitioners traces the program's intellectual genealogy in sequence: Athens (Socratic elenchus as recovered wisdom); Jerusalem (havruta as voluntarily-sustained tradition); Rome (disputatio as institutionally-transmitted practice). The co-investigators travel as learners first, studying each method under practitioners who have never stopped using it. DC functions as the home station, where the formation is brought into contact with the legal and regulatory questions the program is built to answer. The pilgrimage seeds the community of formation that every subsequent cohort will grow into.
