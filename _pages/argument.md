---
layout: page
title: "The Program's Argument"
subtitle: "What LEP trains lawyers to do, under what norm, by what method, against what, and where"
permalink: /argument/
---

# The Program's Argument

The Program trains lawyers to make private law in the act of drafting, under the substantive norm of partnership at shared risk, by formation methods recovered from three surviving traditions, exercised against the live constraint of the federal regulatory state, at the only American law school where the Catholic doctrinal inheritance and the Washington setting converge.

Five elements. Each one earns its place by doing one job in the whole.

## I. What lawyers do

Lawyers make private law. They do not only argue cases in front of judges. The contracts they draft are themselves law for the parties who sign them. The partnership agreement, the operating agreement, the indenture, the lease, the bond covenant: each is a small legal order, with rules and remedies the parties have made for themselves. Robert Cover named this in 1983. *Jurisgenesis* is the activity by which legal meaning is generated in communities, and the drafter of an instrument is one of its principal actors.
...
Partnership at shared risk. The Catholic tradition reaches the formulation through Roman commercial law, Aquinas's distinction between *societas* and *mutuum*, the Salamanca school's commercial moral theology, and the social encyclicals from *Rerum Novarum* through *Magnifica Humanitas*. The Jewish tradition reaches it through the Pentateuchal restrictions on interest, the Talmudic categories of commercial life, Maimonides on *shutafut*, and the *heter iska* as the operative form by which Jewish commercial finance was carried out in practice. Two traditions, working independently across two millennia, end at the same place. Capital deployed into a partnership at shared risk earns a return justly. Capital extended as a loan that demands return without bearing loss is the form the tradition warned against.
...
Three pedagogical methods survived where most others did not. The Socratic *elenchus* (severed from its formative tradition at Athens, partially reclaimed in the modern American law school). The Jewish *ḥavruta* (continuous and communal, never severed from the tradition that formed it). The medieval Catholic *disputatio* (continuous and institutional, sustained inside the universities even as the surrounding curriculum shifted). Three methods, three traditions, one underlying claim about how a practitioner is formed to make sound judgments under pressure.
...
The live regulatory state. Washington is not a fourth station of formation alongside Athens, Jerusalem, and Rome. It is the deployment site where the inherited methods meet friction. A lawyer trained in the recovered methods who never confronts a federal agency, a state attorney general, a congressional subcommittee, or a parallel-sovereign tribal regulator has been formed for a setting that no longer exists.
...
The Catholic University of America Columbus School of Law. The combination is rare and possibly singular. CUA holds the pontifical charter, which means the institution operates under direct ecclesial accountability. It carries the *Ex Corde Ecclesiae* mission, which means the institution treats Catholic doctrine as constitutive of its educational identity rather than as an optional flavor. It sits in Washington, which means the deployment-site engagement happens at street level. And it stands inside the unbroken natural-law tradition, which means the doctrinal vocabulary that supports the substantive norm of partnership at shared risk is the institution's native vocabulary, not a translation.
...
*The essays referenced above sit behind a courtesy gate while in development. The key is shared with collaborators on request.*
