---
layout: page
title: "Tradition Comparison: Catholic & Jewish Thought"
permalink: /traditions-comparison/
mermaid: true
---
...
```mermaid
graph LR
    A["CATHOLIC TRADITION<br/>Foundation: Dignity of Work"] 
    B["JEWISH TRADITION<br/>Foundation: Dignity of Person"]
    
    A -->|"Aquinas: Societas<br/>Partnership at Risk"| C["JUST CAPITAL FORM"]
    B -->|"Maimonides: Shutafut<br/>Partnership with Recipient"| C
    
    C -->|"Modern Application"| D["Partnership-Based Models<br/>- Employee Ownership<br/>- Profit Sharing<br/>- Co-ops<br/>- Mutual Aid<br/>- Social Enterprise"]
